...
def main():
    ...
    with torch.no_grad():
        ...
        checkpoint = torch.load(
            '/home/charain/project/pytorchLearn/Models/hrnet_w48_coco_wholebody_384x288-6e061c6a_20200922.pth')
        ...
        input_path = '/home/charain/project/pytorchLearn/Dataset/rawData/train'
        paths = []
        names = []
        ...
        for i, path in enumerate(paths):
            # if i > 1:
            #     break
            output_npy = '/home/charain/project/pytorchLearn/Dataset/wholepose/{}.npy'.format(
                names[i])
